...
def save_results(original_imgs, activations, save_dir):
    """ Saves the images and the activations at the output folder"""   
...
def get_prediction(image_path: str, model, alpha= 0.5, cutoff = 0.999):
    """ Returns the prediction image and it's original image"""
    # reading the images
    input_img = dt.LoadImage(image_path)()._value / 256
...
def load_model(checkpoint_path: str): 
    """Returns the loaded pre trained model"""
